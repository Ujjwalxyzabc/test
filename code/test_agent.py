...
from agent import PatientHealthReportMetricsExtractorAgent

class TestPatientHealthReportMetricsExtractorAgent:
    
    @pytest.fixture
    def agent(self):
        return PatientHealthReportMetricsExtractorAgent()
